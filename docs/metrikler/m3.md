...
*`scripts/eval/m3_text.py` tarafından üretildi · 08.09.2026 14:57 UTC · commit `5030ed5`*

| | |
|---|---|
| Kontrol noktası | `m3_asama2` |
...
| Görev | Metrik | Değer |
|---|---|---|
| A · iddia tipi (7 sınıf) | makro-F1 | 0.8506 |
| B1 · yanlış bilgi (3 sınıf) | makro-F1 | 0.7262 |
| B2 · yardım çağrısı | makro-F1 | 0.8270 |
...
|---|---|---|---|
| 0.80 | 0.8077 | 0.3214 | 0.0687 |
| 0.85 | 0.8590 | 0.2627 | 0.0971 |
| 0.90 | 0.9103 | 0.1994 | 0.1471 |
| 0.95 | 0.9615 | 0.0832 | 0.4264 |
| 0.98 | 0.9872 | 0.0672 | 0.5514 |
| 0.99 | 1.0000 | 0.0416 | 0.9282 |
...
- Duyarlılık: **0.9359**
- Kesinlik: 0.1587
- Yanlış pozitif oranı: 0.1998 (sınır 0.2)
