...
*`scripts/eval/m5_knowledge.py` tarafından üretildi · 12.09.2026 11:21 UTC · commit `eab1f09`*
...
| **Cümle gömmesi (e5)** | **0.857** | **0.964** | **0.911** |
...
| geri getirme + NLI çıkarımı | 2 | 5 | 21 |
...
|---|---|---|---|
| top1 | 0.828 | 0.883 | ❌ hayır |
| top1 eksi top10 | 0.010 | 0.058 | ❌ hayır |
| z skoru | 3.841 | 6.746 | ❌ hayır |
...
|---|---|
| bugün hava çok güzel, parkta yürüyüşe çıktım | 0.818 |
| akşam yemeğine ne yapsam karar veremedim | 0.808 |
| yarınki maçın kadrosu açıklandı mı acaba | 0.831 |
| yeni telefon almak istiyorum öneriniz var mı | 0.818 |
| enkaz altındayız lütfen yardım edin adres antakya sümerler | 0.832 |
| afad koordinasyonunda ekipler sahada çalışmaya devam ediyor | 0.883 |
| kan bağışı için kızılay şubelerine gidebilirsiniz | 0.841 |
