...
*`scripts/eval/m5_knowledge.py` tarafından üretildi · 08.09.2026 18:52 UTC · commit `01361d3`*
...
|---|---|---|---|
| sözlük (eşik 0,34) | 3 | 0 | 25 |
| sözlük 0,25 + geri getirme vetosu | 8 | 0 | 20 |
| geri getirme + NLI çıkarımı | 1 | 5 | 22 |
